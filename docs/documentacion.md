...
![CI/CD Pipeline](assets/ci-cdgrafico.png)
...
Se puede importar la coleccion de Postman mediante este archivo: [Postman Collection](TrabajoFinal.postman_collection.json)
...
![Sin cache](assets/sin_cache.png)
