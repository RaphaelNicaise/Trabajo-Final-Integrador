    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-cyan-50 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Nueva Contraseña</h1>
          <p className="text-slate-600 text-lg">Ingresá tu nueva contraseña</p>
        </div>
          ...
          {success ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-slate-600 text-sm">
                Tu contraseña fue restablecida exitosamente. Serás redirigido al login en unos segundos...
              </p>
              <Link
                href="/login"
