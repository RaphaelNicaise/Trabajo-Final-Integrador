...
// Rutas de promociones (protegidas)
router.put('/:id/promotion', authMiddleware, tenantMiddleware, (req, res) => productController.setPromotion(req, res));
router.delete('/:id/promotion', authMiddleware, tenantMiddleware, (req, res) => productController.removePromotion(req, res));
