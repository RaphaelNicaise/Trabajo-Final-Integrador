    ...
    html: `
      ...
      <body>
        <div class="main">
          <div class="header">
            <h1>StoreHub</h1>
            <p>Invitación a tienda</p>
          </div>
          <div class="content">
            <div class="title">¡Te invitaron a una tienda!</div>
            <div class="subtitle">Hola <strong>${data.userName}</strong>,<br><strong>${data.ownerName}</strong> te invitó a ser administrador de la tienda <strong>"${data.shopName}"</strong>. Hacé clic en el botón de abajo para aceptar la invitación.</div>
            <div style="text-align:center;">
              <a href="${data.acceptLink}" class="cta-btn">Aceptar Invitación</a>
            </div>
            ...
            <div class="link-block">${data.acceptLink}</div>
          </div>
          <div class="footer">
