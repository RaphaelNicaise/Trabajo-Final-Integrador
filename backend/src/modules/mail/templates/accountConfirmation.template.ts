...
export const accountConfirmationTemplate = (data: AccountConfirmationTemplateData) => {
  return {
    subject: 'Confirmá tu cuenta - StoreHub',
    html: `
      <!DOCTYPE html>
      <html lang="es">
      <head>
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                ...
                <tr>
                  <td style="background-color:#16a34a; padding:28px 32px;">
                    ...
                    <p style="margin:4px 0 0; color:#bbf7d0; font-size:13px;">Confirmación de cuenta</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:32px;">
                    ...
                    <p style="margin:0 0 24px; color:#64748b; font-size:14px; line-height:1.6;">
                      Gracias por registrarte en StoreHub. Para activar tu cuenta, hacé clic en el botón de abajo.
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                      <tr>
                        <td align="center">
                          <a href="${data.confirmLink}" style="display:inline-block; background-color:#16a34a; color:#ffffff; padding:14px 32px; font-size:15px; font-weight:600; text-decoration:none; border-radius:6px;">
                            Confirmar mi Cuenta
                          </a>
                        </td>
                      </tr>
                    ...
                    <p style="margin:4px 0 0; color:#16a34a; font-size:11px; word-break:break-all;">
                      ${data.confirmLink}
                    </p>
                  </td>
                </tr>
